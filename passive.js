...
chrome.storage.local.get(null, (settings) => {
    ...
    if (settings.extensionState) {
        ...
        if (window.location.href.startsWith("https://letterboxd.com/film/") && window.location.href.split("/").length == 6) {
            ...
            // runtime
            if (settings.friendlyRuntime == true) {
            ...
            async function useWikidata() {
                ...
                if (data.results.bindings[0]) {
                    // budget & box office
                    if (settings.boxOffice || settings.budget) {
                    ...
                    // wiki & mojo button
                    if (settings.wikiButton || settings.mojoButton) {
                    ...
                    if (settings.mpaRating) {
                        ...
                        if (mpa && mpa.value != null) createMpaRating()
                    }
                }
            }
            useWikidata()
            ...
            // html formatting
            if (settings.reviewFormattingShortcuts || settings.reviewFormattingButtons) {
                                    ...
                                    <ul class="release-country-list">
                                        <li class="listitem">
                                            <span class="release-country -has-no-link -has-no-certification -has-no-note">
                                                <span class="flag -has-flag"><img src="https://raw.githubusercontent.com/olekdrabina/letterboxdEnhancer/main/assets/world_flag.png" alt="Flag for World"></span>
            ...
            // icons
            if (settings.featureLengthIcon || settings.shortLengthIcon || settings.tvSeriesIcon) {
                let movieRuntime
                if (document.querySelector("#film-page-wrapper > div.col-17 > section.section.col-10.col-main > p > span:nth-child(1) > div > div.twipsy-inner") != null) {
                    movieRuntime = document.querySelector("#film-page-wrapper > div.col-17 > section.section.col-10.col-main > p > span:nth-child(1) > div > div.twipsy-inner").innerHTML.split(" ")[0]
                } else {
                    movieRuntime = document.querySelector("#film-page-wrapper > div.col-17 > section.section.col-10.col-main > p > span:nth-child(1)").innerText.split(" ")[0] 
                }
                ...
                if (settings.shortLengthIcon && movieType == "movie" && movieRuntime <= 40) {
                    createIcon("short-length_icon", "Short movie")
                }
        ...
        // === HOME PAGE ===
        if (window.location.origin === "https://letterboxd.com") {
        ...
        if (window.location.href.startsWith("https://letterboxd.com/films/")) {
            if (settings.hidePopularFilmsWatchesFilms || settings.hidePopularFilmsListsFilms || settings.hidePopularFilmsLikesFilms || settings.hidePopularFilmsTop500Films) {
